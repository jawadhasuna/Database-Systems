...
SELECT* FROM emp;
SELECT* FROM emp WHERE EmpID>10 OR Department='IT';
SELECT* FROM emp WHERE Salary IN (25000,20000,10000,15000,62000);
SELECT* FROM emp WHERE EmpID<105 AND CITY='Islamabad';
